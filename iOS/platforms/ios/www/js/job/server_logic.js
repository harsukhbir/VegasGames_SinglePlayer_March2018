...
function jb_get_hand(){
    ...
    req.open("GET", server_url + "job_get_hand?uid="+uname+"&sid="+sid+"&b="+bet, true);
    req.send(null);
}

function jb_draw_new(){
    ...
    req.open("GET", server_url + "job_draw?uid="+uname+"&sid="+sid + "&rep="+selected_str+"&b="+bet, true);
    req.send(null);
