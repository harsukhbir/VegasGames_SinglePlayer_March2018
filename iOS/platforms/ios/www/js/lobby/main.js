...
function show_create_form(){
    for(var i = 0; i < create_form.length; i++){
        $(create_form[i]).show();
        // create_form.style.visibility = "visible";
...
function hide_create_form(){
    for(var i = 0; i < create_form.length; i++){
        $(create_form[i]).hide();
        // create_form[i].style.visibility = "hidden";
        //create_form[i].style.visibility = "visible";
    }
    //alert("Hid Create Form");
}
...
function show_login_form(){
    for(var i = 0; i < login_form.length; i++){
        ...
        //$(login_form[i]).attr("visibility", "visible");
        //login_form[i].style.visibility = "visible";
//login_form[i].setAttribute("style", "visible");
    }
}
