...
var Who_Just_Installed_App_To_Send_Invite_Another_Person_No = {
  "Who Just Installing The App To Send An Invite To Another Person No": "1"
    ...
    window.plugins.appsFlyer.trackEvent(User_Invite_Social_Events, User_Invite_Social_Events_No);

    if (localStorage.getItem("openGames") == null || localStorage.getItem("openGames") == undefined) {

        window.plugins.appsFlyer.trackEvent(Who_Just_Installed_App_To_Send_Invite_Another_Person, Who_Just_Installed_App_To_Send_Invite_Another_Person_No);
    }
