var MoneyWheel = {
    ...
    */
        ...
        MoneyWheel.Sounds = {
            ...
            win: function(){
                ...
                if(MoneyWheel.Wheel.pies[MoneyWheel.Result].value == '1'){
                    ...
                    window.plugins.appsFlyer.trackEvent(MoneyWhell_Complete_Level, MoneyWhell_Complete_Level_No);
        ...
        if(!MoneyWheel.Spinning && MoneyWheel.SpinComplete && !isBigSpin && !MoneyWheel.ClickResolved){
            if(Math.floor(experience / 100) > Math.floor((experience - 15) / 100)){
                ...
                if(MoneyWheel.Games > 0){
                    ...
                    window.plugins.appsFlyer.trackEvent(MoneyWhell_New_Game, MoneyWhell_New_Game_No);
                    var x = event.clientX - canvas.offsetLeft;
                    var y = event.clientY - canvas.offsetTop;
    ...
    begin_spin: function(){
        ...
        window.plugins.appsFlyer.trackEvent(MoneyWhell_Replay_Game, MoneyWhell_Replay_Game_No);
