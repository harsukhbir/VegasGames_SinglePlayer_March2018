...
I would like to use this space to note that Jokers are Wild and therefore not logical
...
function init_jw(){
    ...
    //hand_types = ["Natural Royal Flush", "Five of a Kind", "Wild Royal Flush",  "Straight Flush", "Four of a Kind", "Full House", "Flush", "Straight", "Three of a Kind", "Two Pair", "Kings or Better"];
