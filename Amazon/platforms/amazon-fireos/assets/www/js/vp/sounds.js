function vp_sound_init(){
    ...
    announcement_sounds.push(new Audio('sound/Video_Poker/Voice_Win_Announcment/apairof.wav'));
    announcement_sounds.push(new Audio('sound/Video_Poker/Voice_Win_Announcment/jacks.wav'));
