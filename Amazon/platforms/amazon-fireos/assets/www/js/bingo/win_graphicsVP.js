...
function vp_draw_win_graphics(){
    ...
    if(last_winning != 0){
        ...
        var txt = "YOU WIN!";
        auto_size_text("YOU WIN!", star_transform[2] * 0.5, win_height);
        draw_win_text(txt,
    ...
    // Lose Display
        ...
        auto_size_text("YOU WIN!", star_transform[2], star_transform[3]);
        var txt = "YOU LOSE!";
        draw_win_text(txt,
                star_transform[0] + star_transform[2] * 0.5 - context.measureText(txt).width * 0.35,
                star_transform[1] + star_transform[3] * 0.65
                );
        auto_size_text("YOU WIN!", star_transform[2], star_transform[3] * 0.1);
        txt = vp_lose_phrase;
        draw_win_text(txt,
                star_transform[0] + star_transform[2] * 0.5 - context.measureText(txt).width * 0.35,
...
function vp_reset_win_graphics(){
    ...
    var phrases = [
        ...
        "LETS TRY AGAIN... THIS TIME THING!",
...
function vp_draw_expbar(){
    ...
    drawRotatedImage(vp_exp_bar_wheel, transform, exp_bar.angle)
}
